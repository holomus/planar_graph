create or replace package Ui_Vhr264 is
  ----------------------------------------------------------------------------------------------------
  Function Query(p Hashmap) return Fazo_Query;
end Ui_Vhr264;
/
create or replace package body Ui_Vhr264 is
  ----------------------------------------------------------------------------------------------------
  ...
  begin
    ...
    q.Number_Field('t_audit_id',
                   ...
                   'rank_id',
                   'fte');
    q.Varchar2_Field('t_event', 't_source_project_code', 'employment_type');
