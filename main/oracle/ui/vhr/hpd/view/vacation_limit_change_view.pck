create or replace package Ui_Vhr604 is
  ----------------------------------------------------------------------------------------------------
...
/
create or replace package body Ui_Vhr604 is
  ----------------------------------------------------------------------------------------------------
  ...
  begin
    ...
    Result.Put('division_name',
               z_Mhr_Divisions.Take(i_Company_Id => Ui.Company_Id, i_Filial_Id => Ui.Filial_Id, i_Division_Id => r_Limit_Change.Division_Id).Name);
  
    Result.Put_All(Get_Limit_Changes(r_Journal.Journal_Id, r_Limit_Change.Change_Date));
