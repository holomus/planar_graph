create or replace package Ui_Vhr394 is
  ----------------------------------------------------------------------------------------------------
...
/
create or replace package body Ui_Vhr394 is
  ----------------------------------------------------------------------------------------------------
  ...
  begin
    ...
    q.Number_Field('t_audit_id', 't_user_id', 't_context_id', 'reason_id');
  ...
  Function Model(p Hashmap) return Hashmap is
    ...
    result       Hashmap;
  begin
    r_Data := z_Href_Business_Trip_Reasons.Load(i_Company_Id => v_Company_Id,
                                                i_Filial_Id  => Ui.Filial_Id,
                                                i_Reason_Id  => p.r_Number('reason_id'));
  
    result := z_Href_Business_Trip_Reasons.To_Map(r_Data,
                                                  z.Reason_Id,
                                                  z.Name,
                                                  z.State,
                                                  z.Code,
  ...
  begin
    update x_Href_Business_Trip_Reasons
