create or replace package Ui_Vhr122 is
  ----------------------------------------------------------------------------------------------------
...
/
create or replace package body Ui_Vhr122 is
  ----------------------------------------------------------------------------------------------------  
  Function t
  (
    i_Message varchar2,
  ...
  begin
    return b.Translate('UI-VHR122:' || i_Message, i_P1, i_P2, i_P3, i_P4, i_P5);
  end;
  ...
  begin
    if Ui.User_Id = Ui.User_Admin then
      v_Is_Admin := 'Y';
    end if;
  ...
  begin
    ...
    Uit_Href.Assert_Access_To_Staff(r_Request.Staff_Id);
